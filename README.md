...
`YOUR_USER_NAME` should be replaced with your email.\
`YOUR_API_KEY` should be replaced with the key obtained from Admin -> Channels -> API.\
`YOUR_DOMAIN` should be replaced with your domain. (i.e. https://yourdomain.zendesk.com/api/v2/)
